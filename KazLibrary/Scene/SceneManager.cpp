...
SceneManager::SceneManager() :gameFirstInitFlag(false)
{
	...
	m_rayPipeline = std::make_unique<Raytracing::RayPipeline>(m_pipelineShaders, Raytracing::HitGroupMgr::DEF, 7, 2, 6, payloadSize, static_cast<int>(sizeof(KazMath::Vec2<float>)), 6);
