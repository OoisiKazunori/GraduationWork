...
namespace BasicDraw
{
	...
	DrawFuncData::DrawCallData SetTex(bool arg_z = false);
	...
	struct BasicTextureRender
	{
		...
		void Load(DrawingByRasterize &arg_rasterize, const std::string &arg_filePass, bool arg_isUIFlag = false, bool arg_deletePipelineInScene = false);
		void Load(bool arg_z,DrawingByRasterize &arg_rasterize, const std::string &arg_filePass);
