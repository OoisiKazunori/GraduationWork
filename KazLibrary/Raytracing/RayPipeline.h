...
namespace Raytracing {
	...
	private:
		...
		KazBufferHelper::BufferData* m_refEchoConstBufferData;
	...
	public:
		...
		void SetEchoStructuredBufferData(KazBufferHelper::BufferData* arg_echStructuredBufferData) { m_refEchoConstBufferData = arg_echStructuredBufferData; }
